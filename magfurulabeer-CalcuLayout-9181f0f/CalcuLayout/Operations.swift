...
public func <> (firstView: UIView, secondView: UIView) -> [NSLayoutConstraint] {    
    let topConstraint = firstView.top <> secondView.top
    let bottomConstraint = firstView.bottom <> secondView.bottom
    let leadingConstraint = firstView.leading <> secondView.leading
    let trailingConstraint = firstView.trailing <> secondView.trailing
...
public postfix func ++ (constraints: [NSLayoutConstraint]) {
